 ...
 */
public class wonGame_fragment extends Fragment {
    private saveViewModel model;

    /**
     * Empty constructor
     */
    public wonGame_fragment() {
     ...
     * @return the layout for the won game fragment
     */
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_won_game_fragment, container, false);
    }
    /**
     * Displays the number of tries left the user had when the Hangman game was won
     * Displays the right word of the won Hangman game
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        setTexttoView(Integer.toString(model.getHangman().getTriesLeft()), R.id.triesLeft2);
        setTexttoView(model.getHangman().getRealWord(), R.id.displayWord2);
    ...
    /**
     * Clears the current toolbar and replaces it with a custom toolbar for the won game fragment
